...
public class Script {
    ...
    public void updateFortnutDB() {
        ...
        try {
            ...
            crud.update(userStatsAction(getUsernameEncoded("pedrop_monkaaaas"), "pc"));
            ...
            crud.update(userStatsAction(getUsernameEncoded("freaking_lukas"), "ps4"));
            ...
            crud.update(userStatsAction(getUsernameEncoded("fuchiniano"), "pc"));
